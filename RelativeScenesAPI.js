...
var Сamera = Java.type("mchorse.aperture.capabilities.camera.Camera");
...
function MoveScene(frames, actions, params)
{
    ...
    frames.forEach(function(frame)
    {
        ...
        frame.x = position.x + delta.x;
        frame.y = position.y + delta.y;
        frame.z = position.z + delta.z;
        i++;
    });
...
function ClearCash(name) 
{
    ...
    {
        var camera = Сamera.get(players[i].getMCEntity());
